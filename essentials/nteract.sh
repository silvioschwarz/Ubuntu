...
python3 -m pip install ipykernel --user # install the python kernel (ipykernel) globally
python3 -m ipykernel install --user     # install python kernel into nteract's available kernel list
